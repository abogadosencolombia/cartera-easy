                ...
                <div class="flex flex-col md:flex-row items-center justify-between gap-6">
                    <div class="flex items-center gap-5">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500 dark:text-gray-400 mt-1 font-medium italic">Gestión de entidades judiciales y despachos</p>
                        </div>
                    </div>
                        ...
                        <table class="w-full text-sm text-left">
                            <thead>
                                <tr class="text-xs text-gray-500 uppercase bg-gray-50/50 dark:bg-gray-700/50 dark:text-gray-400 border-b border-gray-100 dark:border-gray-700">
                                    ...
                                    <th scope="col" class="px-6 py-3 font-bold">Información de Contacto</th>
                                    <th scope="col" class="px-6 py-3 font-bold text-right">Acciones</th>
                                </tr>
                            </thead>
                            <tbody class="divide-y divide-gray-50 dark:divide-gray-700">
                                <tr v-for="juzgado in juzgados.data" :key="juzgado.id" class="group hover:bg-indigo-50/50 dark:hover:bg-indigo-900/20 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-sm">
                                    <td class="px-6 py-3.5">
                                        <div class="flex items-center gap-3.5">
                                            <div class="flex-shrink-0 h-9 w-9 rounded-xl bg-gradient-to-br from-indigo-500 to-blue-600 flex items-center justify-center text-white text-[10px] font-black shadow-sm group-hover:scale-110 transition-transform">
                                                {{ getInitials(juzgado.nombre) }}
                                            </div>
                                            <div>
                                                <div class="font-bold text-gray-900 dark:text-white text-sm leading-tight group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors">
                                                    {{ juzgado.nombre }}
                                                </div>
                                    ...
                                    <td class="px-6 py-3.5 text-right">
                                        <div class="flex justify-end items-center gap-2" v-if="$page.props.auth.user.tipo_usuario === 'admin'">
                                            ...
                                            <button 
                                                ...
                                                class="p-2 text-red-500 bg-red-50 dark:bg-red-900/20 dark:text-red-400 hover:text-white hover:bg-red-600 dark:hover:bg-red-500 rounded-xl transition-all duration-200 hover:scale-110 active:scale-95 shadow-sm hover:shadow-md" 
