            ...
            <div class="flex items-center justify-between bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700">
                <div class="flex items-center gap-4">
                    <div class="p-3 bg-blue-50 dark:bg-blue-900/30 rounded-xl">
                        <PencilIcon class="h-8 w-8 text-blue-600 dark:text-blue-400" />
                    </div>
                    <div>
                        <h2 class="font-black text-2xl text-gray-900 dark:text-white leading-tight">
                            Editar Información del Despacho
                        </h2>
                        <p class="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Modificando registro: <span class="font-bold text-gray-700 dark:text-gray-200">{{ juzgado.nombre }}</span></p>
                    </div>
                </div>
