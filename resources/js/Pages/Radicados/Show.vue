...
const actualizarActuacion = () => {
    ...
    editActuacionForm.put(route('procesos.actuaciones.update', actuacionEnEdicion.value.id), {
        preserveScroll: true,
        onSuccess: () => {
            cerrarModalEditar()
            router.reload({ only: ['proceso'], preserveState: true })
                ...
                <div class="p-4 sm:p-6">
                    <fieldset :disabled="isClosed">
                        <form @submit.prevent="guardarActuacion" class="mb-6 pb-6 border-b dark:border-gray-700">
                            <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100 mb-2">Nueva Actuación Manual</h3>
