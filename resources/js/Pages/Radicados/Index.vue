...
watch([search, estado], applyFilters);
        ...
        <div class="py-8">
            <div class="max-w-8xl mx-auto sm:px-6 lg:px-8 space-y-6">
                    ...
                    <div class="flex flex-col md:flex-row gap-4 justify-between">
                        <div class="relative flex-grow max-w-2xl">
                            ...
                            <TextInput 
                                ...
                                placeholder="Buscar por radicado, nombres, cédula/NIT, juzgado..." 
                            />
                        </div>
                        
                        <div class="flex items-center gap-3">
                            <div class="flex items-center gap-2 bg-gray-50 dark:bg-gray-900 px-3 py-2 rounded-md border border-gray-300 dark:border-gray-600">
                        ...
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                            <thead class="bg-gray-50 dark:bg-gray-700/50">
                                <tr>
                                    ...
                                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Juzgado / Ubicación</th>
                                ...
                                <tr v-for="proceso in procesos.data" :key="proceso.id" class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors group">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="space-y-2">
                                            <div class="flex items-start gap-2">
                                                ...
                                                <span class="text-xs text-gray-700 dark:text-gray-300 line-clamp-2" :title="proceso.demandantes.map(p => p.nombre_completo).join(', ')">
                                            ...
                                            <div class="flex items-start gap-2">
                                                ...
                                                <span class="text-xs text-gray-700 dark:text-gray-300 line-clamp-2" :title="proceso.demandados.map(p => p.nombre_completo).join(', ')">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex flex-col gap-1">
                                            <div 
                                                class="flex items-center gap-1.5 text-xs font-semibold px-2 py-1 rounded-full w-fit"
                                            ...
                                            <span class="text-[10px] text-gray-400 ml-1">
                                                {{ proceso.fecha_proxima_revision }}
                                            </span>
                                        </div>
                                    </td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full"
                                            :class="proceso.estado === 'ACTIVO' ? 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400' : 'bg-gray-100 text-gray-800 dark:bg-gray-700 dark:text-gray-300'">
                                            {{ proceso.estado }}
                                        </span>
                                    </td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <div class="flex items-center justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                                            <Link :href="route('procesos.show', proceso.id)" class="text-indigo-600 hover:text-indigo-900 dark:text-indigo-400 dark:hover:text-indigo-300 bg-indigo-50 dark:bg-indigo-900/20 p-1.5 rounded-md hover:bg-indigo-100 transition-colors" title="Ver Detalle">
                                            ...
                                            <Dropdown align="right" width="48">
                                                <template #trigger>
                                                    <button class="text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 p-1.5 rounded-md hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                                                ...
                                                <template #content>
                                                    ...
                                                    <button 
                                                        ...
                                                        @click="openCloseModal(proceso)" 
                                                        class="block w-full text-left px-4 py-2 text-sm leading-5 text-red-600 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none transition duration-150 ease-in-out"
                                                    >
                                                        Cerrar Caso
                                                    </button>
                                                    <button 
                                                        v-if="proceso.estado === 'CERRADO'"
                                                        @click="openReopenModal(proceso)" 
                                                        class="block w-full text-left px-4 py-2 text-sm leading-5 text-green-600 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none transition duration-150 ease-in-out"
                                                    >
                                                        Reabrir Caso
                                                    </button>
                                                </template>
                ...
                <div class="md:hidden space-y-4">
                    ...
                    <div v-for="proceso in procesos.data" :key="proceso.id" class="bg-white dark:bg-gray-800 p-4 rounded-lg shadow border-l-4" 
                        :class="proceso.estado === 'ACTIVO' ? 'border-l-indigo-500' : 'border-l-gray-400 opacity-75'">
                        <div class="flex justify-between items-start mb-3">
                            ...
                            <span class="px-2 py-1 text-[10px] font-bold rounded-full bg-gray-100 dark:bg-gray-700">
                                {{ proceso.estado }}
                            </span>
                        </div>
                        ...
                        <div class="space-y-2 text-sm text-gray-700 dark:text-gray-300 mb-4">
                            ...
                            <div class="flex gap-2 items-center mt-2 bg-gray-50 dark:bg-gray-700/50 p-2 rounded">
                                <CalendarDaysIcon class="h-4 w-4 text-gray-400" />
                                <span class="text-xs font-medium" :class="getRevisionStatus(proceso.fecha_proxima_revision).textClass">
                                    Revisión: {{ proceso.fecha_proxima_revision }}
                                </span>
                            </div>
                        </div>
