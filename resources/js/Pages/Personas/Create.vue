    ...
    <template #header>
      <div class="flex flex-col md:flex-row items-center justify-between gap-4">
        <div class="flex items-center gap-4">
            <Link :href="route('personas.index')" class="p-2.5 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg text-gray-400 hover:text-indigo-600 transition-all shadow-sm">
        ...
        <form @submit.prevent="submit" class="space-y-5">
          ...
          <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm overflow-hidden">
            ...
            <div class="p-5 grid grid-cols-1 md:grid-cols-2 gap-5">
                <div class="md:col-span-2 space-y-2">
                    ...
                    <TextInput v-model="form.nombre_completo" type="text" class="w-full rounded-lg border-gray-200 focus:ring-indigo-500 font-bold text-lg" placeholder="Ej: Juan Pérez o Empresa S.A.S" required />
            ...
            <div class="p-5 grid grid-cols-1 md:grid-cols-2 gap-5">
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        ...
                        <TextInput v-model="form.celular_1" class="pl-10 w-full rounded-lg border-gray-200" placeholder="300..." />
                    </div>
                </div>
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        ...
                        <TextInput v-model="form.correo_1" type="email" class="pl-10 w-full rounded-lg border-gray-200" placeholder="ejemplo@correo.com" />
                    </div>
                </div>
                <div class="space-y-2">
          ...
          <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm overflow-hidden">
            ...
            <div class="p-5 grid grid-cols-1 md:grid-cols-2 gap-5">
                <div class="space-y-2">
                    ...
                    <TextInput v-model="form.empresa" class="w-full rounded-lg border-gray-200" />
                </div>
                <div class="space-y-2">
                    <InputLabel value="Cargo Actual" class="font-bold text-xs uppercase" />
                    <TextInput v-model="form.cargo" class="w-full rounded-lg border-gray-200" />
                </div>
                <div class="md:col-span-2 space-y-2">
                    <InputLabel value="Observaciones del Perfil" class="font-bold text-xs uppercase" />
                    <Textarea v-model="form.observaciones" rows="3" class="w-full rounded-lg border-gray-200" placeholder="Información relevante para cobranza o seguimiento..." />
                </div>
            </div>
          </div>
          ...
          <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm overflow-hidden">
            ...
            <div class="p-5">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div v-for="(l, idx) in form.social_links" :key="idx" class="p-5 bg-gray-50 dark:bg-gray-900/50 rounded-lg border border-gray-100 dark:border-gray-700 relative group animate-in zoom-in-95 duration-200 flex items-end gap-3">
