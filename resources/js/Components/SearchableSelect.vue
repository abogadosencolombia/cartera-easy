...
const floatingStyles = computed(() => {
    const dropdownHeight = 320; // max-h-80 aproximado
        ...
        <div class="relative" ref="container">
            ...
            >
                <Teleport to="body">
                    <ComboboxOptions 
                        v-if="true"
                        class="fixed mt-1 max-h-80 overflow-auto rounded-xl bg-white dark:bg-gray-800 py-1 text-base shadow-2xl ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm z-[9999] border dark:border-gray-700 backdrop-blur-sm"
